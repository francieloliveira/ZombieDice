...
while not list(nojogo.keys()):
    ...
    while not WIN or not list(players.keys()):
        ...
        time.sleep(3)
        lastPlayed[playerName] = {'cerebro': cerebro, 'passo': passo, 'tiro': tiro}
        ...
        while True:
            ...
            if status == "n":
                copo.clear()
                nojogo[playerName] = {'cerebro': cerebro, 'passo': passo, 'tiro': tiro}
                break
